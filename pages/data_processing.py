    ...
    if (len(xgoalFilesList) != len(statsFilesList)) or (len(statsFilesList) != len(eventsFilesList))\
        ...
        for statsFile in statsFilesList:
            ...
            if ('lineUp' not in liveData):
                ...
                eventFile = homeTeam + '_' + awayTeam + '_events.json'
...
# teamId = "2aofpfcn4ads3zzip4q9n6udy"
# directory = "./Opta stats/2022 data/"
# xGoalFilesList = ['BOL_EAS_xgoal_stats.json', 'BRR_BOL_xgoal_stats.json', 'BOL_GCU_xgoal_stats.json', 'BOL_BCT_xgoal_stats.json', 'MBJ_BOL_xgoal_stats.json', 'BOL_LIG_xgoal_stats.json', 'CAP_BOL_xgoal_stats.json', 'BOL_PEN_xgoal_stats.json', 'LIO_BOL_xgoal_stats.json', 'BOL_GCK_xgoal_stats.json', 'SCW_BOL_xgoal_stats.json', 'EAS_BOL_xgoal_stats.json', 'BOL_BRR_xgoal_stats.json', 'GCU_BOL_xgoal_stats.json', 'BCT_BOL_xgoal_stats.json', 'BOL_MBJ_xgoal_stats.json', 'LIG_BOL_xgoal_stats.json', 'BOL_CAP_xgoal_stats.json']
# statsFilesList = ['BOL_EAS_stats.json', 'BRR_BOL_stats.json', 'BOL_GCU_stats.json', 'BOL_BCT_stats.json', 'MBJ_BOL_stats.json', 'BOL_LIG_stats.json', 'CAP_BOL_stats.json', 'BOL_PEN_stats.json', 'LIO_BOL_stats.json', 'BOL_GCK_stats.json', 'SCW_BOL_stats.json', 'EAS_BOL_stats.json', 'BOL_BRR_stats.json', 'GCU_BOL_stats.json', 'BCT_BOL_stats.json', 'BOL_MBJ_stats.json', 'LIG_BOL_stats.json', 'BOL_CAP_stats.json']
# eventsFilesList = ['BOL_EAS_events.json', 'BRR_BOL_events.json', 'BOL_GCU_events.json', 'BOL_BCT_events.json', 'MBJ_BOL_events.json', 'BOL_LIG_events.json', 'CAP_BOL_events.json', 'BOL_PEN_events.json', 'LIO_BOL_events.json', 'BOL_GCK_events.json', 'SCW_BOL_events.json', 'EAS_BOL_events.json', 'BOL_BRR_events.json', 'GCU_BOL_events.json', 'BCT_BOL_events.json', 'BOL_MBJ_events.json', 'LIG_BOL_events.json', 'BOL_CAP_events.json']

# olympic_data = totalData(teamId, directory, xGoalFilesList, statsFilesList, eventsFilesList)
# print(olympic_data)