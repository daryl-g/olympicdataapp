...
def app():
    ...
    st.title("Opposition - Last match")
    ...
    for i in range(0, len(fixtures)):
        ...
        if (fixtures['Home team code'][i] == 'BOL') or (fixtures['Away team code'][i] == 'BOL'):
            ...
            if (today <= parsed):
                ...
                home_away = 'Home'
                if (fixtures["Home team"][i] == 'Olympic FC'):
                    upcomingTeam = fixtures["Away team"][i]
                    home_away = 'Home'
                elif (fixtures["Away team"][i] == 'Olympic FC'):
    ...
    elif (upcomingTeam == 'Capalaba'): oppositionCode = 'CAP'
    ...
    elif (upcomingTeam == 'Logan Lightning'): oppositionCode = 'LIG'
    ...
    if (upcomingTeam == 'Brisbane City'): 
        ...
        teamId = teamIdLions
    elif (upcomingTeam == 'Logan Lightning'): 
    ...
    teamCodes.remove(teamCodes[2])
    home_team = teamCodes[0]
    away_team = teamCodes[1]
